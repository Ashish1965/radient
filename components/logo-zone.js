const LogoZone = () => {
    return (
      <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[11px] pl-0 box-border max-w-full text-left text-sm text-lightgray font-inter">
        <div className="flex-1 bg-gray-200 flex flex-row items-center justify-center max-w-full">
          <div className="self-stretch w-[1592px] relative bg-gray-200 hidden max-w-full" />
          <div className="overflow-x-auto flex flex-row items-center justify-start pt-3.5 px-0 pb-[13px] box-border relative gap-[0px_41px] max-w-full mq750:gap-[0px_41px]">
            ...
            <div className="w-[491px] shrink-0 flex flex-row flex-wrap items-center justify-center [row-gap:20px] max-w-[calc(100%_-_533px)]">
              <div className="flex-1 flex flex-row items-center justify-start relative min-w-[302px] max-w-full">
                ...
                <div className="w-[415px] flex flex-row items-start justify-between relative gap-[20px] max-w-full mq450:flex-wrap">
                  <div className="h-full w-full absolute !m-[0] top-[0px] bottom-[0px] left-[0px] z-[9]" />
                  <div className="w-[76px] flex flex-row items-start justify-start pt-[3px] pb-px pr-[3px] pl-0 box-border relative">
                    <div className="h-full w-full absolute !m-[0] top-[-0.5px] right-[3px] bottom-[1.5px] left-[0px] z-[10]" />
